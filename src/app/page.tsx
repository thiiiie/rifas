...
import { PRICE, products } from "./constants";
    ...
    <div className="flex flex-col items-center">
      ...
      <main className="relative -top-2 max-w-[600px] w-full bg-rifa-background p-4 rounded-2xl">
        <section className="bg-background rounded-2xl">
          <Image className="rounded-2xl w-full aspect-[5/4] object-cover rounded-b-none" width={600} height={600} priority src={products.caminhao.image} alt="imagem do produto" />

          <div className="p-4">
            <h1 className="text-md font-medium leading-5">{products.caminhao.name}</h1>
            <p className="text-xs text-gray-600">10 bilhetes premiados no valor de R$5.000,00</p>
        ...
        <RifaForm productId={products.caminhao.id} />
