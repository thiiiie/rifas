...
import { PRICE_KIT, products } from "../constants";
    ...
    <div className="flex flex-col items-center">
      ...
      <main className="relative top-5 max-w-[600px] w-full bg-rifa-background p-4 rounded-2xl">
        <section className="bg-background rounded-2xl">
          ...
          <div className="p-4">
            <h1 className="text-md font-medium leading-5">{products.kit.name}</h1>
        ...
        <RifaForm productId={products.kit.id} price={PRICE_KIT} minQuantity={2} />
